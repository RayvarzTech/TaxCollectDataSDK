...
namespace TaxCollectData.Library.Api
{
    internal class DefaultTaxApiClient : ITaxApis
    {
        ...
        public void GetServerInformationManual()
        {
            KeyDto publicKey = new(
           ...
           SetEncryptionConfig(new ServerInformationModel(DateTimeOffset.Now.ToUnixTimeMilliseconds(), new List<KeyDto>() { publicKey}));
        }
    }
}